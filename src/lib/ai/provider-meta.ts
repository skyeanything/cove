...
export const PROVIDER_METAS: Record<ProviderType, ProviderMeta> = {
  ...
  aliyun: {
    ...
    knownModelDetails: {
      "qwen3-max": { reasoning: true, tool_calling: true, vision: true },
      "qwen3-80b": { reasoning: true, tool_calling: true, vision: true },
      "qwen3-32b": { reasoning: true, tool_calling: true, vision: true },
      "qwen3.5-35b-a3b": { reasoning: true, tool_calling: true },
      "qwen3.5-27b": { reasoning: true, tool_calling: true },
      "qwen3.5-9b": { reasoning: true, tool_calling: true },
      "qwq-plus": { reasoning: true, tool_calling: true },
    },
  },
  deepseek: {
    type: "deepseek",
