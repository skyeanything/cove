...
export function CodeBlock({
  ...
  const renderPreview = useCallback(() => {
    if (isHtml) {
      try {
        // SAFETY: AI-generated HTML preview; script tags hidden via CSS [&_script]:hidden
        return (
          <div
    ...
    if (isMermaid) {
      try {
        ...
        // SAFETY: SVG generated by renderMermaidSVG() from diagram syntax, not arbitrary HTML
        return (
          <div
